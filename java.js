	...
	if (!gameover) {
	    ...
	    if (danger) {
			...
			if (health<10) {
			    ...
			    ctx.fillText("ዝቅተኛ ህይወት",stage.w/2,stage.h*0.6);
			}
	    } else {
	    	dangera = 0;
	    }
	    ...
	    ctx.textAlign = "left"; 
	    ctx.textBaseline = "middle"; 
	    ctx.fillText("ጤና: ",20,40);

	    ctx.fillText("ውጤት: "+score,stage.w-200,40);
	    ...
	    ctx.font = "bold 50px arial";
	    ctx.fillText("ውጤት: "+score,stage.w/2,stage.h/2);

	    ctx.font = "bold 30px arial";

	    ctx.fillText("ድጋሜ ተጫወት",stage.w/2,stage.h*0.65);
	    ...
	    ctx.textAlign = "center"; 
	    ctx.textBaseline = "middle"; 
	    ctx.fillText("ኮረናን እንዋጋ",stage.w/2,stage.h-20);
}
